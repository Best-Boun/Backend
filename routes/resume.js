...
function buildDataJson(body, fallback = {}) {
  ...
  return JSON.stringify({
    ...
    email:          email          !== undefined ? String(email).trim()     : f.email          || "",
    phone:          phone          !== undefined ? String(phone).trim()     : f.phone          || "",
    location:       location       !== undefined ? String(location).trim()  : f.location       || "",
    linkedin:       linkedin       !== undefined ? String(linkedin).trim()  : f.linkedin       || "",
    github:         github         !== undefined ? String(github).trim()    : f.github         || "",
    website:        website        !== undefined ? String(website).trim()   : f.website        || "",
    ...
    certifications: Array.isArray(certifications) ? certifications          : f.certifications || [],
    projects:       Array.isArray(projects)       ? projects                : f.projects       || [],
